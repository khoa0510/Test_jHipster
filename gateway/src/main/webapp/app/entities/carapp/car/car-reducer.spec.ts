...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './car.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAR actions', async () => {
      const expectedActions = [
        {
